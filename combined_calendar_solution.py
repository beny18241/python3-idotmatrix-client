...
def get_combined_events(meeting_type="tomorrow"):
    ...
    try:
        if meeting_type == "tomorrow":
            ics_events = get_ics_events_for_tomorrow("https://outlook.office365.com/owa/calendar/144d73fdf2654fb3b92983ee16e9d0b3@genpt.com/e829a99fc26b4c66a482420d04ea689513863417029725141930/calendar.ics")
        elif meeting_type == "current":
            ics_events = get_ics_events_for_current("https://outlook.office365.com/owa/calendar/144d73fdf2654fb3b92983ee16e9d0b3@genpt.com/e829a99fc26b4c66a482420d04ea689513863417029725141930/calendar.ics")
        elif meeting_type == "today":
            ics_events = get_ics_events_for_today("https://outlook.office365.com/owa/calendar/144d73fdf2654fb3b92983ee16e9d0b3@genpt.com/e829a99fc26b4c66a482420d04ea689513863417029725141930/calendar.ics")
        else:
...
def display_combined_events_on_device(device_address, meeting_type="tomorrow"):
    ...
    events = get_combined_events(meeting_type)
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python combined_calendar_solution.py <device_address> [meeting_type]")
        ...
        print("  python combined_calendar_solution.py DD:4F:93:46:DF:1A current")
        print("  python combined_calendar_solution.py DD:4F:93:46:DF:1A today")
        return
    ...
    success = display_combined_events_on_device(device_address, meeting_type)
